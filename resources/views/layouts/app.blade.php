   ...
   <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   	...
   	<body class="font-sans text-gray-900 text-sm bg-gray-background">
   		<header class="flex items-center justify-between px-8 py-4">
   			<a href="#"><img class="h-18 w-24" src=" {{ asset('img/logo.svg') }} "
   					alt="logo"></a>
   		...
   		<main class="container mx-auto max-w-custom flex">
   			<div class="w-70 mr-5">
				Add idea form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum eligendi quos culpa in, libero, nisi mollitia commodi earum eos dolorum excepturi corrupti molestiae repellat vitae. Fugit adipisci dolor deleniti officia perspiciatis, voluptas doloribus, repudiandae possimus asperiores qui dolores consectetur nulla?
   			</div>
   			<div class="w-175">
